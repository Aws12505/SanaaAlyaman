...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Testimonial', href: '/admin/testimonials/create' },
];
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Information about the customer who left the review
                                    </CardDescription>
                                </CardHeader>
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        The customer's review and rating
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="space-y-2">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Upload a photo of the customer (optional)
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
